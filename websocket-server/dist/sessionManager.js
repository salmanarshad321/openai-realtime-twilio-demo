...
function tryConnectModel() {
    ...
    session.modelConn.on("open", () => {
        ...
        jsonSend(session.modelConn, {
            type: "session.update",
            session: Object.assign({ modalities: ["text", "audio"], turn_detection: { type: "server_vad" }, voice: "ash", input_audio_transcription: { model: "whisper-1" }, input_audio_format: "g711_ulaw", output_audio_format: "g711_ulaw", instructions: "You are a career counsellor. Answer questions using the context in this url: https://gocareerguru.com/profile-design" }, config),
        });
